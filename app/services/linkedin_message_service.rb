...
class LinkedinMessageService
  ...
  def create_automation
    ...
    if automation.save
      LinkedinMessageJob.set(wait_until: @params[:programmed_to]).perform_later(automation.id.to_s)
      OpenStruct.new(success?: true, message: 'Linkedin message scheduled successfully')
    else
